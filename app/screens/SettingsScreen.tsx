      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.rowValue}>demo@ocat.com</Text>
          </View>
          ...
          <View style={styles.card}>
            <Text style={styles.aboutTitle}>OCAT v{appVersion}</Text>
            <Text style={styles.aboutText}>
              OCAT 源自日语「おしえて（oshiete）」— 请教教我。{'\n\n'}
          ...
          <View style={styles.card}>
            <Text style={styles.aboutText}>
              OCAT 的核心理念是「可理解输入」（Comprehensible Input）。{'\n\n'}
          ...
          <View style={styles.linkCard}>
            <Pressable onPress={() => Linking.openURL('https://github.com/your-org/ocat')} style={styles.linkRow}>
              <Text style={styles.link}>开源许可: MIT</Text>
            </Pressable>
            <Pressable onPress={() => Linking.openURL('https://ocat.app/privacy')} style={styles.linkRow}>
              <Text style={styles.link}>隐私政策</Text>
            </Pressable>
            <Pressable onPress={() => Linking.openURL('https://ocat.app/terms')} style={styles.linkRow}>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: Colors.card, borderRadius: 16, padding: 16, borderWidth: 1, borderColor: Colors.headerBorder },
  ...
  stepBtn: { width: 32, height: 32, borderRadius: 16, backgroundColor: Colors.stepperBg, justifyContent: 'center', alignItems: 'center' },
  stepValue: { fontSize: 15, fontWeight: '600', color: Colors.stepperText, minWidth: 24, textAlign: 'center' },
  textInput: { borderWidth: 1, borderColor: Colors.textInputBorder, borderRadius: 12, padding: 10, fontSize: 14, color: Colors.textInputText, marginTop: 8, width: '100%', backgroundColor: Colors.textInputBg },
  chipRow: { flexDirection: 'row', gap: 6, flexWrap: 'wrap', justifyContent: 'flex-end' },
  chip: { paddingVertical: 6, paddingHorizontal: 12, borderRadius: 16, backgroundColor: Colors.chipBg },
  ...
  clearBtn: { marginTop: 12, paddingVertical: 12, borderRadius: 24, backgroundColor: Colors.clearBtnBg, alignItems: 'center' },
  ...
  linkCard: { backgroundColor: Colors.linkCardBg, borderRadius: 16, padding: 16, borderWidth: 1, borderColor: Colors.linkCardBorder, marginTop: 16 },
